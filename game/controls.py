...
def touch_platform(doodle, platforms):
  """track if Doodle stands on platform and if he is, change direction of moving"""
...
def touch_spring(doodle, springs):
  """track if Doodle jumps on spring and if he is, change direction of moving and 
  increase speed"""
...
def crack_platforms_crash(platforms):
  """track if Doodle stands on crack platform, and if he is, change direction of moving
